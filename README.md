...
```bash
npm install https://github.com/malbit/node-cryptonight-hashing.git
```
...
var algorithms = ['cryptonight', 'cryptonight_light', 'cryptonight_heavy', 'cryptonight_pico', 'cryptonight_arqma'];
