...
#define ARQMA_MEMORY() (m_variant >= 2 ? xmrig::CRYPTONIGHT_ARQMA_MEMORY : xmrig::CRYPTONIGHT_LITE_MEMORY)
    ...
    public:
        ...
        CCryptonightArqmaAsync(Nan::Callback* const callback, const char* const input, const uint32_t input_len, const int variant)
            ...
            m_ctx->memory = static_cast<uint8_t *>(_mm_malloc(ARQMA_MEMORY(), 4096));
        }
        ...
        void Execute () {
            switch (m_variant) {
                case 0: cryptonight_single_hash<xmrig::CRYPTONIGHT_ARQMA, SOFT_AES, xmrig::VARIANT_0>(reinterpret_cast<const uint8_t*>(m_input), m_input_len, reinterpret_cast<uint8_t*>(m_output), &m_ctx, 0);
                        break;
                case 1: cryptonight_single_hash<xmrig::CRYPTONIGHT_ARQMA, SOFT_AES, xmrig::VARIANT_1>(reinterpret_cast<const uint8_t*>(m_input), m_input_len, reinterpret_cast<uint8_t*>(m_output), &m_ctx, 0);
                        break;
                case 2:
#if !SOFT_AES && defined(CPU_INTEL)
                        cryptonight_single_hash_asm<xmrig::CRYPTONIGHT_ARQMA, xmrig::VARIANT_2, xmrig::ASM_INTEL>(reinterpret_cast<const uint8_t*>(m_input), m_input_len, reinterpret_cast<uint8_t*>(m_output), &m_ctx, 0);
#elif !SOFT_AES && defined(CPU_AMD)
                        cryptonight_single_hash_asm<xmrig::CRYPTONIGHT_ARQMA, xmrig::VARIANT_2, xmrig::ASM_RYZEN>(reinterpret_cast<const uint8_t*>(m_input), m_input_len, reinterpret_cast<uint8_t*>(m_output), &m_ctx, 0);
#elif !SOFT_AES && defined(CPU_AMD_OLD)
                        cryptonight_single_hash_asm<xmrig::CRYPTONIGHT_ARQMA, xmrig::VARIANT_2, xmrig::ASM_BULLDOZER>(reinterpret_cast<const uint8_t*>(m_input), m_input_len, reinterpret_cast<uint8_t*>(m_output), &m_ctx, 0);
#else
