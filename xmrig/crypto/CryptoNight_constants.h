...
template<> inline constexpr uint32_t cn_select_iter<CRYPTONIGHT_ARQMA, VARIANT_ARQ>()  { return CRYPTONIGHT_ARQMA_ITER; }
...
template<> inline constexpr Variant cn_base_variant<VARIANT_ARQ>()    { return VARIANT_2; }
