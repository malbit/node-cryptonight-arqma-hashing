...
void xmrig::CpuThread::patchAsmVariants()
{
    ...
    cn_arqma_mainloop_ivybridge_asm             = reinterpret_cast<cn_mainloop_fun>         (base + 0x4000);
    cn_arqma_mainloop_ryzen_asm                 = reinterpret_cast<cn_mainloop_fun>         (base + 0x5000);
    cn_arqma_mainloop_bulldozer_asm             = reinterpret_cast<cn_mainloop_fun>         (base + 0x6000);
    cn_arqma_double_mainloop_sandybridge_asm    = reinterpret_cast<cn_mainloop_double_fun>  (base + 0x7000);
